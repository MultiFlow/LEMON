...
int rnd_seq32[] = {2732,  43567, 42613, 52416, 45891, 21243, 30403, 32103,
...
int rnd_seq64[] = {56382, 63883, 59577, 64750, 9644,  59886, 57647, 18152,
...
int main() {
  ...
  lemon::rnd.seed(100);
  lemon::rnd.seed(
      seed_array, seed_array + (sizeof(seed_array) / sizeof(seed_array[0])));
