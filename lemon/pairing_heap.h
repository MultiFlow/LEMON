...
class PairingHeap {
 ...
 public:
  ...
  explicit PairingHeap(ItemIntMap& map) : _min(0), _iim(map), _num_items(0) {}
    ...
    switch (_data[a].degree) {
      ...
      case 1:
        ...
        if (!_data[child_a].left_child) {
          ...
          --_data[b].degree;
          if (_data[a].left_child) {
            _data[b].child = (1 == _data[b].degree) ? _data[a].parent : -1;
          } else {
            if (1 == _data[b].degree)
      ...
      case 0:
        --_data[b].degree;
        if (_data[a].left_child) {
          _data[b].child = (0 != _data[b].degree) ? _data[a].parent : -1;
        } else {
          if (0 != _data[b].degree)
            _data[_data[b].child].parent = b;
          else
