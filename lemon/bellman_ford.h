...
class BellmanFord {
 ...
 public:
  ...
  struct SetOperationTraits
    ...
    typedef BellmanFord<Digraph, LengthMap, SetOperationTraitsTraits<T>> Create;
  };
 ...
 public:
  ...
  LemonRangeWrapper1<ActiveIt, BellmanFord> activeNodes() const {
...
/// \tparam LEN The type of the length map.
template<typename GR, typename LEN>
class BellmanFordWizardBase : public BellmanFordWizardDefaultTraits<GR, LEN> {
...
class BellmanFordWizard : public TR {
 ...
 public:
  ...
  /// \param gr The digraph the algorithm runs on.
  /// \param len The length map.
  BellmanFordWizard(const Digraph& gr, const LengthMap& len) : TR(gr, len) {}
  ...
  void run(Node s) {
    BellmanFord<Digraph, LengthMap, TR> bf(
...
/// \sa BellmanFord
template<typename GR, typename LEN>
BellmanFordWizard<BellmanFordWizardBase<GR, LEN>> bellmanFord(
    const GR&  digraph,
    const LEN& length) {
