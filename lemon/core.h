...
struct CountNodesSelector<
  ...
  static int count(const Graph& g) { return g.nodeNum(); }
};
} // namespace _core_bits
...
struct CountRedNodesSelector<
    Graph,
    typename enable_if<typename Graph::NodeNumTag, void>::type> {
  static int count(const Graph& g) { return g.redNum(); }
};
} // namespace _graph_utils_bits
...
struct CountBlueNodesSelector<
    Graph,
    typename enable_if<typename Graph::NodeNumTag, void>::type> {
  static int count(const Graph& g) { return g.blueNum(); }
};
} // namespace _graph_utils_bits
...
struct CountArcsSelector<
  ...
  static int count(const Graph& g) { return g.arcNum(); }
};
} // namespace _core_bits
...
struct CountEdgesSelector<
  ...
  static int count(const Graph& g) { return g.edgeNum(); }
};
} // namespace _core_bits
...
struct DigraphCopySelector {
  ...
  static void copy(
    ...
    for (typename From::ArcIt it(from); it != INVALID; ++it) {
      arcRefMap[it] =
          to.addArc(nodeRefMap[from.source(it)], nodeRefMap[from.target(it)]);
    }
  }
};
...
struct GraphCopySelector {
  ...
  static void copy(
    ...
    for (typename From::EdgeIt it(from); it != INVALID; ++it) {
      edgeRefMap[it] =
          to.addEdge(nodeRefMap[from.u(it)], nodeRefMap[from.v(it)]);
    }
  }
};
...
struct BpGraphCopySelector {
  template<
      typename From,
      typename RedNodeRefMap,
      typename BlueNodeRefMap,
      typename EdgeRefMap>
  static void copy(
      const From&     from,
      BpGraph&        to,
    ...
    for (typename From::EdgeIt it(from); it != INVALID; ++it) {
      edgeRefMap[it] = to.addEdge(
          redNodeRefMap[from.redNode(it)], blueNodeRefMap[from.blueNode(it)]);
    }
  }
};
...
#else
template<typename GR>
typename enable_if<UndirectedTagIndicator<GR>, bool>::type undirected(
    const GR&) {
  return true;
}
template<typename GR>
typename disable_if<UndirectedTagIndicator<GR>, bool>::type undirected(
    const GR&) {
  return false;
}
#endif
...
class DigraphCopy {
 ...
 public:
  ...
  DigraphCopy& nodeRef(NodeRef& map) {
    _node_maps.push_back(
        new _core_bits::RefCopy<From, Node, NodeRefMap, NodeRef>(map));
    return *this;
  }
  ...
  DigraphCopy& nodeCrossRef(NodeCrossRef& map) {
    _node_maps.push_back(
        new _core_bits::CrossRefCopy<From, Node, NodeRefMap, NodeCrossRef>(
            map));
    return *this;
  }
  ...
  DigraphCopy& nodeMap(const FromMap& map, ToMap& tmap) {
    _node_maps.push_back(
        new _core_bits::MapCopy<From, Node, NodeRefMap, FromMap, ToMap>(
            map, tmap));
    return *this;
  }
  ...
  DigraphCopy& node(const Node& node, TNode& tnode) {
    _node_maps.push_back(
        new _core_bits::ItemCopy<From, Node, NodeRefMap, TNode>(node, tnode));
    return *this;
  }
  ...
  DigraphCopy& arcRef(ArcRef& map) {
    _arc_maps.push_back(
        new _core_bits::RefCopy<From, Arc, ArcRefMap, ArcRef>(map));
    return *this;
  }
  ...
  DigraphCopy& arcCrossRef(ArcCrossRef& map) {
    _arc_maps.push_back(
        new _core_bits::CrossRefCopy<From, Arc, ArcRefMap, ArcCrossRef>(map));
    return *this;
  }
  ...
  DigraphCopy& arcMap(const FromMap& map, ToMap& tmap) {
    _arc_maps.push_back(
        new _core_bits::MapCopy<From, Arc, ArcRefMap, FromMap, ToMap>(
            map, tmap));
    return *this;
  }
  ...
  DigraphCopy& arc(const Arc& arc, TArc& tarc) {
    _arc_maps.push_back(
        new _core_bits::ItemCopy<From, Arc, ArcRefMap, TArc>(arc, tarc));
    return *this;
  }
  ...
  void run() {
    ...
    _core_bits::DigraphCopySelector<To>::copy(
        _from, _to, nodeRefMap, arcRefMap);
    for (int i = 0; i < int(_node_maps.size()); ++i) {
 ...
 protected:
  ...
  std::vector<_core_bits::MapCopyBase<From, Node, NodeRefMap>*> _node_maps;

  std::vector<_core_bits::MapCopyBase<From, Arc, ArcRefMap>*> _arc_maps;
};
...
class GraphCopy {
 ...
 public:
  ...
  GraphCopy& edgeRef(EdgeRef& map) {
    _edge_maps.push_back(
        new _core_bits::RefCopy<From, Edge, EdgeRefMap, EdgeRef>(map));
    return *this;
  }
  ...
  GraphCopy& edgeCrossRef(EdgeCrossRef& map) {
    _edge_maps.push_back(
        new _core_bits::CrossRefCopy<From, Edge, EdgeRefMap, EdgeCrossRef>(
            map));
    return *this;
  }
  ...
  GraphCopy& edgeMap(const FromMap& map, ToMap& tmap) {
    _edge_maps.push_back(
        new _core_bits::MapCopy<From, Edge, EdgeRefMap, FromMap, ToMap>(
            map, tmap));
    return *this;
  }
  ...
  GraphCopy& edge(const Edge& edge, TEdge& tedge) {
    _edge_maps.push_back(
        new _core_bits::ItemCopy<From, Edge, EdgeRefMap, TEdge>(edge, tedge));
    return *this;
  }
  ...
  void run() {
    ...
    _core_bits::GraphCopySelector<To>::copy(_from, _to, nodeRefMap, edgeRefMap);
    for (int i = 0; i < int(_node_maps.size()); ++i) {
      _node_maps[i]->copy(_from, nodeRefMap);
    }
    for (int i = 0; i < int(_edge_maps.size()); ++i) {
 ...
 private:
  ...
  std::vector<_core_bits::MapCopyBase<From, Edge, EdgeRefMap>*> _edge_maps;
};
...
class BpGraphCopy {
 private:
  ...
  struct NodeRefMap {
    NodeRefMap(
        const From&           from,
        const RedNodeRefMap&  red_node_ref,
        const BlueNodeRefMap& blue_node_ref)
        : _from(from),
          _red_node_ref(red_node_ref),
 ...
 public:
  ...
  BpGraphCopy& redRef(RedRef& map) {
    _red_maps.push_back(
        new _core_bits::RefCopy<From, RedNode, RedNodeRefMap, RedRef>(map));
    return *this;
  }
  ...
  BpGraphCopy& redCrossRef(RedCrossRef& map) {
    _red_maps.push_back(
        new _core_bits::CrossRefCopy<From, RedNode, RedNodeRefMap, RedCrossRef>(
            map));
    return *this;
  }
  ...
  BpGraphCopy& redNodeMap(const FromMap& map, ToMap& tmap) {
    _red_maps.push_back(
        new _core_bits::MapCopy<From, RedNode, RedNodeRefMap, FromMap, ToMap>(
            map, tmap));
    return *this;
  }
  ...
  BpGraphCopy& redNode(const RedNode& node, TRedNode& tnode) {
    _red_maps.push_back(
        new _core_bits::ItemCopy<From, RedNode, RedNodeRefMap, TRedNode>(
            node, tnode));
    return *this;
  }
  ...
  BpGraphCopy& blueRef(BlueRef& map) {
    _blue_maps.push_back(
        new _core_bits::RefCopy<From, BlueNode, BlueNodeRefMap, BlueRef>(map));
    return *this;
  }
  ...
  BpGraphCopy& blueCrossRef(BlueCrossRef& map) {
    _blue_maps.push_back(
        new _core_bits::
            CrossRefCopy<From, BlueNode, BlueNodeRefMap, BlueCrossRef>(map));
    return *this;
  }
  ...
  BpGraphCopy& blueNodeMap(const FromMap& map, ToMap& tmap) {
    _blue_maps.push_back(
        new _core_bits::MapCopy<From, BlueNode, BlueNodeRefMap, FromMap, ToMap>(
            map, tmap));
    return *this;
  }
  ...
  BpGraphCopy& blueNode(const BlueNode& node, TBlueNode& tnode) {
    _blue_maps.push_back(
        new _core_bits::ItemCopy<From, BlueNode, BlueNodeRefMap, TBlueNode>(
            node, tnode));
    return *this;
  }
  ...
  void run() {
    ...
    _core_bits::BpGraphCopySelector<To>::copy(
        _from, _to, redNodeRefMap, blueNodeRefMap, edgeRefMap);
    for (int i = 0; i < int(_node_maps.size()); ++i) {
      _node_maps[i]->copy(_from, nodeRefMap);
    }
    for (int i = 0; i < int(_red_maps.size()); ++i) {
 ...
 private:
  ...
  std::vector<_core_bits::MapCopyBase<From, RedNode, RedNodeRefMap>*> _red_maps;
...
template<typename Graph>
inline typename Graph::Arc findArc(
    const Graph&         g,
...
class ConArcIt : public GR::Arc {
 ...
 public:
  ...
  ConArcIt& operator++() {
    Parent::operator=(
        findArc(_graph, _graph.source(*this), _graph.target(*this), *this));
    return *this;
  }
...
///\sa ConEdgeIt
template<typename Graph>
inline typename Graph::Edge findEdge(
    const Graph&         g,
    typename Graph::Node u,
    typename Graph::Node v,
...
///\sa AllArcLookUp
template<typename GR>
class DynArcLookUp : protected ItemSetTraits<GR, typename GR::Arc>::
                         ItemNotifier::ObserverBase {
  typedef
      typename ItemSetTraits<GR, typename GR::Arc>::ItemNotifier::ObserverBase
          Parent;
 ...
 protected:
  virtual void add(const Arc& arc) { insert(arc); }
  ...
  virtual void erase(const Arc& arc) { remove(arc); }
...
class ArcLookUp {
 ...
 public:
  ...
  /// changes.
  ArcLookUp(const Digraph& g) : _g(g), _head(g), _left(g), _right(g) {
    refresh();
  }
 ...
 public:
  ...
  Arc operator()(Node s, Node t) const {
    Arc e;
    for (e = _head[s]; e != INVALID && _g.target(e) != t;
