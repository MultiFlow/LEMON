...
class Dijkstra {
 ...
 public:
  ...
  /// It must conform to the \ref concepts::WriteMap "WriteMap" concept.
  template<class T>
  struct SetPredMap : public Dijkstra<Digraph, LengthMap, SetPredMapTraits<T>> {
  ...
  /// It must conform to the \ref concepts::WriteMap "WriteMap" concept.
  template<class T>
  struct SetDistMap : public Dijkstra<Digraph, LengthMap, SetDistMapTraits<T>> {
  ...
  struct SetStandardProcessedMap
    ...
    typedef Dijkstra<Digraph, LengthMap, SetStandardProcessedMapTraits> Create;
  };
  ...
  struct SetHeap : public Dijkstra<Digraph, LengthMap, SetHeapTraits<H, CR>> {
  ...
  struct SetStandardHeap
    ...
    typedef Dijkstra<Digraph, LengthMap, SetStandardHeapTraits<H, CR>> Create;
  };
  ...
  struct SetOperationTraits
    ...
    typedef Dijkstra<Digraph, LengthMap, SetOperationTraitsTraits<T>> Create;
  };
 ...
 public:
  ...
  bool processed(Node v) const {
    return (*_heap_cross_ref)[v] == Heap::POST_HEAP;
  }
...
struct DijkstraWizardDefaultTraits {
  ...
  typedef BinHeap<
      Value,
      typename Digraph::template NodeMap<int>,
      std::less<Value>>
      Heap;
...
class DijkstraWizard : public TR {
 ...
 public:
  ...
  /// in order to compute the shortest path to each node.
  void run(Node s) {
    Dijkstra<Digraph, LengthMap, TR> dijk(
        *reinterpret_cast<const Digraph*>(Base::_g),
...
///\sa Dijkstra
template<typename GR, typename LEN>
DijkstraWizard<DijkstraWizardBase<GR, LEN>> dijkstra(
    const GR&  digraph,
    const LEN& length) {
