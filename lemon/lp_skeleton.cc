...
int  SkeletonSolverBase::_colByName(const std::string&) const {
  return -1;
}

void SkeletonSolverBase::_getRowName(int, std::string&) const {}
void SkeletonSolverBase::_setRowName(int, const std::string&) {}
int  SkeletonSolverBase::_rowByName(const std::string&) const {
  return -1;
}
...
LpSkeleton::Value LpSkeleton::_getPrimalRay(int) const {
  return 0;
}
LpSkeleton::Value LpSkeleton::_getDualRay(int) const {
  return 0;
}
...
const char* LpSkeleton::_solverName() const {
  return "LpSkeleton";
}
...
MipSkeleton::Value MipSkeleton::_getSol(int) const {
  return 0;
}
...
const char* MipSkeleton::_solverName() const {
  return "MipSkeleton";
}
