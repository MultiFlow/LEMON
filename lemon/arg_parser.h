...
class ArgParser {
 ...
 public:
   ...
   public:
    ...
    operator std::string() {
      ...
      LEMON_ASSERT(
          ...
          std::string() + "Unkown option: '" + _name + "'");
      LEMON_ASSERT(
          i->second.type == ArgParser::STRING,
    ...
    operator double() {
      ...
      LEMON_ASSERT(
          ...
          std::string() + "Unkown option: '" + _name + "'");
      LEMON_ASSERT(
          i->second.type == ArgParser::DOUBLE ||
              i->second.type == ArgParser::INTEGER,
          std::string() + "'" + _name + "' is a floating point option");
      return i->second.type == ArgParser::DOUBLE ? *(i->second.double_p)
                                                 : *(i->second.int_p);
    }
    ///\e
    operator int() {
  ...
  /// Give back the value of an option.
  ///\sa RefType
  RefType operator[](const std::string& n) const { return RefType(*this, n); }
