 ...
 public:
  ...
  struct Constraints {
    void constraints() {
      ...
      {
        checkConcept<
            GraphItemIt<_Digraph, typename _Digraph::Arc>,
        ...
        checkConcept<
            GraphIncIt<
                _Digraph,
                typename _Digraph::Arc,
                typename _Digraph::Node,
                'i'>,
            typename _Digraph::InArcIt>();
        checkConcept<
            GraphIncIt<
                _Digraph,
                typename _Digraph::Arc,
 ...
 public:
  ...
  struct Constraints {
    void constraints() {
      ...
      {
        checkConcept<
            GraphItemIt<_Graph, typename _Graph::Edge>,
 ...
 public:
  ...
  struct Constraints {
    void constraints() {
      ...
      checkConcept<
          GraphItemIt<_BpGraph, typename _BpGraph::RedNode>,
          typename _BpGraph::RedNodeIt>();
      checkConcept<
          GraphItemIt<_BpGraph, typename _BpGraph::BlueNode>,
...
class GraphMap : public ReferenceMap<K, V, V&, const V&> {
 ...
 public:
  ...
  struct Constraints {
    void constraints() {
      checkConcept<ReferenceMap<Key, Value, Value&, const Value&>, _Map>();
      _Map m1(g);
      _Map m2(g, t);
 ...
 public:
  ...
  class EdgeMap : public GraphMap<MappableGraphComponent, Edge, V> {
   ...
   public:
    ...
    ///
    /// Construct a new map for the graph.
    explicit EdgeMap(const MappableGraphComponent& graph) : Parent(graph) {}
...
class ExtendableDigraphComponent : public BAS {
 public:
  ...
  /// of the digraph.
  Arc addArc(const Node&, const Node&) { return INVALID; }
...
class ExtendableGraphComponent : public BAS {
 public:
  ...
  /// of the graph.
  Edge addEdge(const Node&, const Node&) { return INVALID; }
...
class ExtendableBpGraphComponent : public BAS {
 public:
  ...
  Edge addEdge(const RedNode&, const BlueNode&) { return INVALID; }
  Edge addEdge(const BlueNode&, const RedNode&) { return INVALID; }
