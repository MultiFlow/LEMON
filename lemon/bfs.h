...
#else
template<typename GR = ListDigraph, typename TR = BfsDefaultTraits<GR>>
#endif
class Bfs {
 public:
  /// The type of the digraph the algorithm runs on.
...
class BfsWizard : public TR {
 ...
 public:
  ...
  /// \param g The digraph the algorithm runs on.
  BfsWizard(const Digraph& g) : TR(g) {}
...
class BfsVisit {
 ...
 public:
  ...
  struct SetReachedMap
      : public BfsVisit<Digraph, Visitor, SetReachedMapTraits<T>> {
