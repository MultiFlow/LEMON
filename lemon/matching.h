...
class MaxMatching {
 public:
  ...
  typedef typename Graph::template NodeMap<typename Graph::Arc> MatchingMap;
 ...
 private:
  ...
  void shrinkOnEdge(const Edge& e) {
...

    {
      ...
      while (true) {
        ...
        left =
            (*_blossom_rep)[_blossom_set->find(_graph.target((*_ear)[left]))];
        ...
        if ((*_matching)[right] == INVALID)
          break;
        right = _graph.target((*_matching)[right]);
        right =
            (*_blossom_rep)[_blossom_set->find(_graph.target((*_ear)[right]))];
      ...
      if (nca == INVALID) {
        if ((*_matching)[left] == INVALID) {
          ...
          while (left_set.find(nca) == left_set.end()) {
            ...
            nca = (*_blossom_rep)[_blossom_set->find(
                _graph.target((*_ear)[nca]))];
          }
        } else {
          nca = left;
  ...
  void augmentOnArc(const Arc& a) {
    ...
    for (typename TreeSet::ItemIt it(*_tree_set, tree); it != INVALID; ++it) {
      if ((*_status)[it] == ODD) {
        (*_status)[it] = MATCHED;
      } else {
 ...
 public:
  ...
  MaxMatching(const Graph& graph)
      : _graph(graph),
        ...
        _status(0),
        _ear(0),
        _blossom_set_index(0),
        _blossom_set(0),
        _blossom_rep(0),
        _tree_set_index(0),
        _tree_set(0) {}

  ~MaxMatching() { destroyStructures(); }
  ...
  bool matchingInit(const MatchingMap& matching) {
    ...
    for (EdgeIt e(_graph); e != INVALID; ++e) {
      if (matching[e]) {
        Node u = _graph.u(e);
        if ((*_matching)[u] != INVALID)
          return false;
        (*_matching)[u] = _graph.direct(e, true);
        (*_status)[u]   = MATCHED;

        Node v = _graph.v(e);
        if ((*_matching)[v] != INVALID)
          return false;
  ...
  Arc matching(const Node& n) const { return (*_matching)[n]; }

  /// \brief Return a const reference to the matching map.
  ///
  /// This function returns a const reference to a node map that stores
  /// the matching arc (or edge) incident to each node.
  const MatchingMap& matchingMap() const { return *_matching; }
  ...
  Node mate(const Node& n) const {
    return (*_matching)[n] != INVALID ? _graph.target((*_matching)[n])
                                      : INVALID;
  }
  ...
  Status status(const Node& n) const { return (*_status)[n]; }
  ...
  const StatusMap& statusMap() const { return *_status; }

  /// \brief Return \c true if the given node is in the barrier.
  ///
  /// This function returns \c true if the given node is in the barrier.
  bool barrier(const Node& n) const { return (*_status)[n] == ODD; }
...
#else
template<typename GR, typename WM = typename GR::template EdgeMap<int>>
#endif
class MaxWeightedMatching {
 public:
  ...
  static const int dualScale = std::numeric_limits<Value>::is_integer ? 4 : 1;
 ...
 private:
  ...
  enum Status { EVEN = -1, MATCHED = 0, ODD = 1 };
  ...
  struct NodeData {
    NodeData(IntArcMap& node_heap_index) : heap(node_heap_index) {}
  ...
  void createStructures() {
    ...
    if (!_node_index) {
      ...
      _node_data =
          new RangeMap<NodeData>(_node_num, NodeData(*_node_heap_index));
    } else {
      delete _node_data;
      _node_data =
          new RangeMap<NodeData>(_node_num, NodeData(*_node_heap_index));
  ...
  void matchedToEven(int blossom, int tree) {
    ...
    for (typename BlossomSet::ItemIt n(*_blossom_set, blossom); n != INVALID;
         ++n) {
          ...
          if ((*_blossom_set)[v] > (*_node_data)[vi].heap.prio()) {
            ...
            if ((*_blossom_data)[vb].status == MATCHED) {
              if (_delta2->state(vb) != _delta2->IN_HEAP) {
                _delta2->push(
                    vb,
                    _blossom_set->classPrio(vb) - (*_blossom_data)[vb].offset);
              } else if (
                  (*_delta2)[vb] >
                  _blossom_set->classPrio(vb) - (*_blossom_data)[vb].offset) {
                _delta2->decrease(
  ...
  void matchedToOdd(int blossom) {
    ...
    if (!_blossom_set->trivial(blossom)) {
      _delta4->push(
          blossom,
          (*_blossom_data)[blossom].pot / 2 + (*_blossom_data)[blossom].offset);
    }
  }
            ...
            if ((*_blossom_set)[n] > (*_node_data)[ni].heap.prio()) {
              ...
              if (_delta2->state(blossom) != _delta2->IN_HEAP) {
                _delta2->push(
                  ...
                  (*_delta2)[blossom] > _blossom_set->classPrio(blossom) -
                                            (*_blossom_data)[blossom].offset) {
                _delta2->decrease(
                    blossom,
                    _blossom_set->classPrio(blossom) -
  ...
  void oddToMatched(int blossom) {
    ...
    if (_blossom_set->classPrio(blossom) != std::numeric_limits<Value>::max()) {
      _delta2->push(
          blossom,
          _blossom_set->classPrio(blossom) - (*_blossom_data)[blossom].offset);
    }
  ...
  void shrinkOnEdge(const Edge& edge, int tree) {
...

    {
      ...
      while (true) {
        ...
        left = _blossom_set->find(_graph.target((*_blossom_data)[left].pred));
        left_path.push_back(left);
        left = _blossom_set->find(_graph.target((*_blossom_data)[left].pred));
        left_path.push_back(left);
        ...
        if ((*_blossom_data)[right].pred == INVALID)
          break;

        right = _blossom_set->find(_graph.target((*_blossom_data)[right].pred));
        right_path.push_back(right);
        right = _blossom_set->find(_graph.target((*_blossom_data)[right].pred));
        right_path.push_back(right);
      ...
      if (nca == -1) {
        if ((*_blossom_data)[left].pred == INVALID) {
          nca = right;
          while (left_set.find(nca) == left_set.end()) {
            nca = _blossom_set->find(_graph.target((*_blossom_data)[nca].pred));
    ...
    int surface = _blossom_set->join(subblossoms.begin(), subblossoms.end());
  ...
  void splitBlossom(int blossom) {
    ...
    if (id > ib ? ((id - ib) % 2 == 0) : ((ib - id) % 2 == 1)) {
      for (int i = (id + 1) % subblossoms.size(); i != ib;
           i     = (i + 2) % subblossoms.size()) {
      ...
      for (int i = (ib + 1) % subblossoms.size(); i != id;
           i     = (i + 2) % subblossoms.size()) {
        int sb = subblossoms[i];
        int tb = subblossoms[(i + 1) % subblossoms.size()];
        (*_blossom_data)[sb].next =
    ...
    while (!stack.empty()) {
      if (_blossom_set->trivial(stack.back().blossom)) {
        ...
        while (int(close_stack.size()) > stack.back().close_index) {
          _blossom_potential[close_stack.back()].end =
              _blossom_node_list.size();
        ...
        std::vector<int> subblossoms;
        _blossom_set->split(
            stack.back().blossom, std::back_inserter(subblossoms));
        ...
        for (int i = 1; i < int(subblossoms.size()); i += 2) {
          ...
          stack.push_back(
              ExtractBlossomItem(tb, _graph.source(m), m, close_stack.size()));
        }
      }
    }
  }
 ...
 public:
  ...
  void init() {
    ...
    for (NodeIt n(_graph); n != INVALID; ++n) {
      ...
      _delta1->push(n, max);
      int blossom = _blossom_set->insert(n, std::numeric_limits<Value>::max());
    ...
    for (EdgeIt e(_graph); e != INVALID; ++e) {
      ...
      if (_graph.u(e) != _graph.v(e)) {
        _delta3->push(
            e,
            ((*_node_data)[si].pot + (*_node_data)[ti].pot -
             dualScale * _weight[e]) /
                2);
      }
    }
  ...
  void fractionalInit() {
    ...
    for (NodeIt n(_graph); n != INVALID; ++n) {
      ...
      if ((*_blossom_data)[nb].status != MATCHED)
        continue;
      int ni = (*_node_index)[n];
  ...
  void start() {
    enum OpType { D1, D2, D3, D4 };

    while (_unmatched > 0) {
      Value d1 = !_delta1->empty() ? _delta1->prio()
                                   : std::numeric_limits<Value>::max();

      Value d2 = !_delta2->empty() ? _delta2->prio()
                                   : std::numeric_limits<Value>::max();

      Value d3 = !_delta3->empty() ? _delta3->prio()
                                   : std::numeric_limits<Value>::max();

      Value d4 = !_delta4->empty() ? _delta4->prio()
                                   : std::numeric_limits<Value>::max();
  ...
  ///
  /// \pre Either run() or start() must be called before using this function.
  Arc matching(const Node& node) const { return (*_matching)[node]; }
  ...
  Node mate(const Node& node) const {
    return (*_matching)[node] != INVALID ? _graph.target((*_matching)[node])
                                         : INVALID;
  }
  ...
  ///
  /// \pre Either run() or start() must be called before using this function.
  Value nodeValue(const Node& n) const { return (*_node_potential)[n]; }
  ...
  /// \pre Either run() or start() must be called before using this function.
  /// \see BlossomIt
  int blossomNum() const { return _blossom_potential.size(); }
  ...
  ///
  /// \pre Either run() or start() must be called before using this function.
  Value blossomValue(int k) const { return _blossom_potential[k].value; }
  ...
  class BlossomIt {
   public:
    ...
    operator Node() const { return _algorithm->_blossom_node_list[_index]; }
...
class MaxWeightedPerfectMatching {
 ...
 private:
  ...
  struct BlossomVariable {
    ...
    BlossomVariable(int _begin, Value _value) : begin(_begin), value(_value) {}
  };
