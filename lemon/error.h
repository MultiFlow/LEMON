...
class Exception : public std::exception {
 public:
  ...
  virtual const char* what() const throw() { return "lemon::Exception"; }
};
...
class IoError : public Exception {
 ...
 public:
  ...
  /// Constructor
  explicit IoError(const char* message) throw() { IoError::message(message); }
  ...
  /// Constructor
  explicit IoError(const char* message, const std::string& file) throw() {
    IoError::message(message);
    IoError::file(file);
  }
