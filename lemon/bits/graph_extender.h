 ...
 public:
  ...
  class OutArcIt : public Arc {
   ...
   public:
    ...
    OutArcIt(const Digraph& digraph, const Node& node) : _digraph(&digraph) {
  ...
  class InArcIt : public Arc {
   ...
   public:
    ...
    InArcIt(const Digraph& digraph, const Node& node) : _digraph(&digraph) {
  ...
  Node baseNode(const OutArcIt& arc) const { return Parent::source(arc); }
  // \brief Running node of the iterator
  //
  // Returns the running node (i.e. the target in this case) of the
  // iterator
  Node runningNode(const OutArcIt& arc) const { return Parent::target(arc); }

  // \brief Base node of the iterator
  //
  // Returns the base node (i.e. the target in this case) of the iterator
  Node baseNode(const InArcIt& arc) const { return Parent::target(arc); }
  // \brief Running node of the iterator
  //
  // Returns the running node (i.e. the source in this case) of the
  // iterator
  Node runningNode(const InArcIt& arc) const { return Parent::source(arc); }

  template<typename _Value>
  class NodeMap : public MapExtender<DefaultMap<Digraph, Node, _Value>> {
    typedef MapExtender<DefaultMap<Digraph, Node, _Value>> Parent;

   public:
    explicit NodeMap(const Digraph& digraph) : Parent(digraph) {}
  ...
  class ArcMap : public MapExtender<DefaultMap<Digraph, Arc, _Value>> {
   ...
   public:
    explicit ArcMap(const Digraph& digraph) : Parent(digraph) {}
...
class GraphExtender : public Base {
 ...
 public:
  ...
  static Edge fromId(int id, Edge) { return Parent::edgeFromId(id); }
 ...
 public:
  ...
  class OutArcIt : public Arc {
   ...
   public:
    ...
    OutArcIt(const Graph& graph, const Node& node) : _graph(&graph) {
  ...
  class InArcIt : public Arc {
   ...
   public:
    ...
    InArcIt(const Graph& graph, const Node& node) : _graph(&graph) {
  ...
  template<typename _Value>
  class NodeMap : public MapExtender<DefaultMap<Graph, Node, _Value>> {
    typedef MapExtender<DefaultMap<Graph, Node, _Value>> Parent;

   public:
    explicit NodeMap(const Graph& graph) : Parent(graph) {}
    NodeMap(const Graph& graph, const _Value& value) : Parent(graph, value) {}
  ...
  class ArcMap : public MapExtender<DefaultMap<Graph, Arc, _Value>> {
   ...
   public:
    explicit ArcMap(const Graph& graph) : Parent(graph) {}
    ArcMap(const Graph& graph, const _Value& value) : Parent(graph, value) {}
  ...
  class EdgeMap : public MapExtender<DefaultMap<Graph, Edge, _Value>> {
   ...
   public:
    ...
    EdgeMap(const Graph& graph, const _Value& value) : Parent(graph, value) {}
 ...
 public:
  ...
  class OutArcIt : public Arc {
   ...
   public:
    ...
    OutArcIt(const BpGraph& graph, const Node& node) : _graph(&graph) {
      _graph->firstOut(*this, node);
    }
  ...
  class InArcIt : public Arc {
   ...
   public:
    ...
    InArcIt(const BpGraph& graph, const Node& node) : _graph(&graph) {
      _graph->firstIn(*this, node);
    }
  ...
  template<typename _Value>
  class NodeMap : public MapExtender<DefaultMap<BpGraph, Node, _Value>> {
    typedef MapExtender<DefaultMap<BpGraph, Node, _Value>> Parent;

   public:
    explicit NodeMap(const BpGraph& bpgraph) : Parent(bpgraph) {}
  ...
  template<typename _Value>
  class RedNodeMap : public MapExtender<DefaultMap<BpGraph, RedNode, _Value>> {
    typedef MapExtender<DefaultMap<BpGraph, RedNode, _Value>> Parent;

   public:
    explicit RedNodeMap(const BpGraph& bpgraph) : Parent(bpgraph) {}
  ...
  class BlueNodeMap
   ...
   public:
    explicit BlueNodeMap(const BpGraph& bpgraph) : Parent(bpgraph) {}
  ...
  template<typename _Value>
  class ArcMap : public MapExtender<DefaultMap<BpGraph, Arc, _Value>> {
    typedef MapExtender<DefaultMap<BpGraph, Arc, _Value>> Parent;

   public:
    explicit ArcMap(const BpGraph& graph) : Parent(graph) {}
    ArcMap(const BpGraph& graph, const _Value& value) : Parent(graph, value) {}
  ...
  template<typename _Value>
  class EdgeMap : public MapExtender<DefaultMap<BpGraph, Edge, _Value>> {
    typedef MapExtender<DefaultMap<BpGraph, Edge, _Value>> Parent;

   public:
    explicit EdgeMap(const BpGraph& graph) : Parent(graph) {}

    EdgeMap(const BpGraph& graph, const _Value& value) : Parent(graph, value) {}
  ...
  void build(const BpGraph& graph, NodeRefMap& nodeRef, EdgeRefMap& edgeRef) {
    Parent::build(graph, nodeRef, edgeRef);
