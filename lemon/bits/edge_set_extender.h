 ...
 public:
  ...
  class OutArcIt : public Arc {
   ...
   public:
    ...
    OutArcIt(const Digraph& _graph, const Node& node) : digraph(&_graph) {
  ...
  class InArcIt : public Arc {
   ...
   public:
    ...
    InArcIt(const Digraph& _graph, const Node& node) : digraph(&_graph) {
  ...
  ArcSetExtender() { arc_notifier.setContainer(*this); }

  ~ArcSetExtender() { arc_notifier.clear(); }
};
 ...
 public:
  ...
  class OutArcIt : public Arc {
   ...
   public:
    ...
    OutArcIt(const Graph& _graph, const Node& node) : graph(&_graph) {
      _graph.firstOut(*this, node);
    }
  ...
  class InArcIt : public Arc {
   ...
   public:
    ...
    InArcIt(const Graph& _graph, const Node& node) : graph(&_graph) {
      _graph.firstIn(*this, node);
    }
