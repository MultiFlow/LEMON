...
class Preflow {
 ...
 public:
  ...
  struct SetFlowMap
    ...
    typedef Preflow<Digraph, CapacityMap, SetFlowMapTraits<T>> Create;
  };
  ...
  struct SetElevator
    ...
    typedef Preflow<Digraph, CapacityMap, SetElevatorTraits<T>> Create;
  };
  ...
  struct SetStandardElevator
      : public Preflow<Digraph, CapacityMap, SetStandardElevatorTraits<T>> {
    typedef Preflow<Digraph, CapacityMap, SetStandardElevatorTraits<T>> Create;
  };
 ...
 public:
  ...
  /// \pre Either \ref run() or \ref init() must be called before
  /// using this function.
  Value flowValue() const { return (*_excess)[_target]; }
