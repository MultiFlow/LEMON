...
class NagamochiIbaraki {
 public:
  ...
  struct SetUnitCapacity
      : public NagamochiIbaraki<Graph, CapacityMap, SetUnitCapacityTraits> {
    typedef NagamochiIbaraki<Graph, CapacityMap, SetUnitCapacityTraits> Create;
  };
  ...
  struct SetHeap
    ...
    typedef NagamochiIbaraki<Graph, CapacityMap, SetHeapTraits<H, CR>> Create;
  };
  ...
  /// \sa SetHeap
  template<class H, class CR = RangeMap<int>>
  struct SetStandardHeap : public NagamochiIbaraki<
                               Graph,
                               CapacityMap,
                               SetStandardHeapTraits<H, CR>> {
    typedef NagamochiIbaraki<Graph, CapacityMap, SetStandardHeapTraits<H, CR>>
        Create;
  };
 ...
 public:
  ...
  void init() {
    ...
    for (typename Graph::Node n = _first_node; n != INVALID;
         n                      = (*_nodes)[n].next) {
 ...
 public:
  ...
  Value minCutValue() const { return _min_cut; }
